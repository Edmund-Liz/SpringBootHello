...
import com.springdemo.springboothello.Enum.HttpStatusEnum;
...
public class ResponseResult<T> {
    ...
    public static <T> ResponseResult<T> success(T data) {
        AppLogger.getLogger().info("response success:{}",data);
    ...
    public static <T> ResponseResult<T> success(String message) {
        AppLogger.getLogger().info("response success:{}",message);
    ...
    public static <T> ResponseResult<T> fail() {
        AppLogger.getLogger().info("response fail:No Message");
    ...
    public static <T> ResponseResult<T> fail(Integer code, String message) {
        AppLogger.getLogger().info("response fail({}):{}",code,message);
    ...
    public static <T> ResponseResult<T> fail(String message, T data) {
        AppLogger.getLogger().info("response fail:{}.data:{}",message,data);
